/*
 * Project Name: GPIF_UFS.cyfx
 * Time : 05/25/2015 16:33:55
 * Device Type: FX3
 * Project Type: GPIF2
 *
 *
...
#define READ_DATA 4
#define SEND_DATA 6
#define PREPARE_SEND 2
#define PREPARE_READ 5
#define READ_SET_OE 3
...
uint16_t CyFxGpifTransition[]  = {
    0x0000, 0x0404, 0x4040, 0xAAAA, 0x8888, 0xCCCC, 0xF0F0, 0xC0C0
};
...
CyU3PGpifWaveData CyFxGpifWavedata[]  = {
    {{0x1E148701,0x00040004,0x80000000},{0x00000000,0x00000000,0x00000000}},
    {{0x4E1C9A02,0x04C000CC,0x80000080},{0x3E134703,0x008C000E,0x80000000}},
    {{0x3E728706,0x00C0000A,0x80000040},{0x1E148701,0x00040004,0x80000000}},
    {{0x1E148701,0x00040004,0x80000000},{0x4E1C9A05,0x00800D0C,0x80000080}},
    {{0x3E728704,0x248C000A,0x80000040},{0x1E148701,0x00040004,0x80000000}},
    {{0x1E148701,0x00040004,0x80000000},{0x4E1C9A02,0x04C000CC,0x80000080}}
};
...
uint32_t CyFxGpifRegValue[]  = {
    ...
    0x54001051,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_DIRECTION */
    0x0000FF4F,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_DEFAULT */
    0x0000004D,  /*  CY_U3P_PIB_GPIF_CTRL_BUS_POLARITY */
    ...
    0x000007FF,  /*  CY_U3P_PIB_GPIF_DATA_COUNT_LIMIT */
