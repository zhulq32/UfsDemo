...
#ifndef _INCLUDED_USBTASK_H_
#define _INCLUDED_USBTASK_H_
...
#define CY_FX_MSC_EP_BULK_OUT              0x06    /* EP 1 OUT */
#define CY_FX_MSC_EP_BULK_IN               0x85    /* EP 1 IN */

#define CY_FX_MSC_EP_BULK_OUT_SOCKET        0x06    /* Socket 1 is producer */
#define CY_FX_MSC_EP_BULK_IN_SOCKET         0x05    /* Socket 1 is consumer */
