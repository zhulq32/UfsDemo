...
#define DPDDeviceDescriptor_CLASS        0xDC
#define DPDDeviceDescriptor_SUBCLASS     0x00
#define DPDDeviceDescriptor_PROTOCOL     0x00

/// Class code for a Mass Storage interface.
#define DPDInterfaceDescriptor_CLASS         0xDC
#define DPDInterfaceDescriptor_SUBCLASS      0xA0
#define DPDInterfaceDescriptor_PROTOCOL      0xB0

#define DPDD_Descriptors_INTERFACENUM               0
#define DPDD_Descriptors_BULKIN                		5
#define DPDD_Descriptors_BULKOUT               		6
#define DPDD_Descriptors_CTRLIN                		3
#define DPDD_Descriptors_CTRLOUT               		4
...
const uint8_t CyFxUSBSSConfigDscr[] __attribute__ ((aligned (32))) =
{
    ...
    0xDC,                           /* Interface sub class */
    0xA0,                           /* Interface protocol code */
    0xB0,                           /* Interface descriptor string index */
    ...
    USBEndpointDescriptor_ADDRESS(
        ...
        DPDD_Descriptors_BULKOUT),              /* Endpoint address and description */
    ...
    USBEndpointDescriptor_ADDRESS(
        ...
        DPDD_Descriptors_BULKIN),              /* Endpoint address and description */
    CY_U3P_USB_EP_BULK,             /* Bulk endpoint type */
    0x00,0x04,                      /* Max packet size = 1024 bytes */
    0x00,                           /* Servicing interval for data transfers : 0 for Bulk */
